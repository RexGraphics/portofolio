...
const Shuffle: React.FC<ShuffleProps> = ({
    ...
    () => {
      ...
      const teardown = () => {
        ...
        try {
          ...
          console.log('error pada file splittext');
        }
      ...
      const build = () => {
        ...
        chars.forEach(ch => {
          ...
          wrap.className = 'inline-flex overflow-hidden items-center h-12 align-baseline text-left';
  ...
  const classes = `${baseTw} ${ready ? 'visible' : 'invisible'} ${className} ${fontClass}`.trim();
