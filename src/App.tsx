...
import SplitText from "./components/cummons/SplitText/SplitText";
function App() {
  ...
  return (
    <div className="w-screen h-[200svh] bg-black overflow-hidden">
      <div className={`w-full h-3/4 transition-opacity duration-4000 ${bgOpacity}`}>
        <Aurora
      ...
      <div className={`w-full h-full absolute top-0 left-0 flex justify-content-center align-items-center overflow-hidden transition-opacity duration-500 ${isDone}`}>
        <SplitText
          text="Hi There!"
      ...
      <div className={`w-full h-full absolute top-0 left-0 flex justify-content-center align-items-center overflow-hidden transition-opacity duration-1000 ${isDone2}`}>
